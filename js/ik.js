...
function checkNilai() {
  ...
  var filePath = "data_nilai/nilai_ik.xlsx";
...
function openResultWindow(header, data) {
  ...
  var headerGroups = [
    ...
    ["Total Nilai", "Responsi", "Hadir Sosialisasi", "Nilai Akhir", "Grade"],
  ];
  ...
  var dataGroups = [
    ...
    [data[0][32], data[0][33], data[0][36], data[0][34], data[0][35]], // Total Nilai
  ];
